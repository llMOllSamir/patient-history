...
export default function AddUpdateOsteoporosisHistory({ state = "update" }) {
    ...
    const validationSchema = yup.object({
        ...
        current_oestrogen_use: yup
            .string()
            .required("What Is The Current Oestrogen "),
            ...
            if (state === "update") {
                dispatech(
                    ...
                    if (response.payload.examination) {
                        navigate(`/patient/osteoporosis/${patient.id}`);
                    }
                });
            } else {
                dispatech(
            ...
            <div className="mx-4 lg:mx-16  grid  grid-cols-1 lg:grid-cols-2  gap-5 ">
                <div className="flex flex-col gap-5">
                    ...
                    <SelectedInput
                        ...
                        label={"Weight"}
                        name="weight"
                        opt={["< 60 kg", "60-69 kg", ">= 70 kg"]}
                    />

                    <SelectedInput
                        formik={formik}
                        label={"current oestrogen use"}
                ...
                <div className="flex flex-col gap-2 font-medium">
                    ...
                    />
                    {formik.touched.recommendations &&
                        formik.errors.recommendations && (
...
const SelectedInput = ({ formik, label, opt = [], name = "", placeholder }) => {
    return (
        <div className={`flex flex-col font-medium   capitalize gap-2 `}>
            ...
            <select
                ...
                className={` outline-none   px-5 py-2   border-2  border-gray-400 text-black ${
                    formik.values[name] === "" ? "text-gray-300" : "text-black"
                }  rounded-lg  2xl:w-1/2 w-full `}
            >
                {placeholder && (
