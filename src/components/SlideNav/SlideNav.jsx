...
export default function SlideNav() {
  ...
  return (
    <>
      ...
      <aside className={` select-none overflow-auto   h-screen md:static fixed   z-20   ${isOpen ? "start-0" : "-start-72"} transition-all duration-700     print:hidden min-w-64 md:w-4/12 xl:w-3/12 2xl:w-1/6 lg:w-3/12 w-2/5 bg-fuchsia-900  text-white`}>
